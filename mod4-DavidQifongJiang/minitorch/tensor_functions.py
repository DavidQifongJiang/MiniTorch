...
class Inv(Function):
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Computes the gradient for inversion."""
        (t1,) = ctx.saved_values
...
class Add(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        """Returns the gradient for addition."""
...
class All(Function):
    ...
    def forward(ctx: Context, a: Tensor, dim: Tensor) -> Tensor:
        """Computes the product of tensor elements along a dimension."""
        if dim is not None:
...
class Mul(Function):
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        """Computes the gradient for multiplication."""
...
class Log(Function):
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Computes the gradient for the log function."""
        (t1,) = ctx.saved_values
...
class Exp(Function):
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Computes the gradient for the exp function."""
...
class Sum(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        """Computes the gradient for the sum function."""
...
class LT(Function):
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        """Computes the gradient for the less-than comparison."""
...
class EQ(Function):
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        """Computes the gradient for the equality comparison."""
        t1_shape, t2_shape = ctx.saved_values
        return zeros(t1_shape), zeros(t2_shape)
...
class Permute(Function):
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        """Computes the gradient for the permutation of tensor dimensions."""
...
class View(Function):
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        """Computes the gradient for the view (reshape) operation."""
